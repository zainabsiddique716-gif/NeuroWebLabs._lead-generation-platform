    ...
    <div>
      <div className="flex flex-wrap gap-3 mb-6">
        <input
          ...
          className="bg-[var(--bg-panel)] border border-[var(--border-line)] rounded-lg px-4 py-2.5 text-sm flex-1 min-w-[180px] focus:outline-none focus:ring-2 focus:ring-teal-500"
        />
        <input
          value={location}
        ...
        <button
          onClick={runSearch}
          disabled={loading}
          className="bg-teal-600 hover:bg-teal-500 disabled:bg-slate-700 disabled:text-slate-400 rounded-lg px-6 py-2.5 text-sm font-medium transition-colors"
        >
                ...
                <tr key={b.id} className="border-b border-[var(--border-line)] last:border-0">
                  ...
                  <td className="px-4 py-3 font-mono text-xs">
                    {scraping[b.id] ? (
                      ...
                      <button
                        onClick={() => scrape(b.id)}
                        className="bg-[var(--border-line)] hover:bg-teal-900 rounded px-3 py-1.5 text-xs font-sans"
                      >
                        Scrape email
                      </button>
                    ) : (
